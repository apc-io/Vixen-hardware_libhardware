...
LOCAL_SHARED_LIBRARIES := liblog libcutils libwmtenv libMali libGLESv1_CM $(SHARED_MEM_LIBS)
...
LOCAL_CFLAGS := -DLOG_TAG=\"gralloc\" -DFIX_DISPLAY_EXTERNAL
LOCAL_CFLAGS += -DFIX_DISPLAY_EXTERNAL -DFIX_PIXEL_FORMAT
#endif
